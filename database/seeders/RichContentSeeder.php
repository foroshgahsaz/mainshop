...
class RichContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Page::updateOrCreate(['slug' => 'about'], [
            'title' => 'درباره ما',
            'meta_title' => 'درباره چینی بازار | فروشگاه اینترنتی',
            'meta_description' => 'آشنایی با تیم، ارزش‌ها و خدمات فروشگاه اینترنتی چینی بازار',
            'is_active' => true,
            'content' => <<<HTML
<h2>چینی بازار؛ خرید آنلاین با اطمینان</h2>
<p>چینی بازار از سال ۱۳۹۸ با هدف ساده‌سازی خرید آنلاین برای خانواده‌های ایرانی فعالیت می‌کند. ما باور داریم خرید باید <strong>سریع، شفاف و مطمئن</strong> باشد — از انتخاب محصول تا تحویل درب منزل.</p>

<figure>
    <img src="{$asset('shop/images/hero/slide-discount.svg')}" alt="فروشگاه چینی بازار">
    <figcaption>نمایی از تجربه خرید در چینی بازار</figcaption>
</figure>
...
<div class="info-box">
    <strong>می‌دانید؟</strong> تیم چینی بازار متشکل از متخصصان فناوری، لجستیک و تجربه مشتری است که هر روز برای بهبود خدمات تلاش می‌کنند.
</div>
HTML,
        ]);
        ...
        Page::updateOrCreate(['slug' => 'contact'], [
            ...
            'meta_description' => 'راه‌های ارتباط با پشتیبانی، فروش و واحد فنی فروشگاه چینی بازار',
            'is_active' => true,
            'content' => <<<HTML
...
<figure>
    <img src="{$asset('shop/images/hero/slide-ai.svg')}" alt="دفتر چینی بازار">
...
HTML,
        ...
        Post::updateOrCreate(['slug' => 'complete-shopping-guide-chapino'], [
            'title' => 'راهنمای جامع خرید آنلاین از چینی بازار — تست کامل محتوا',
            'user_id' => $author?->id,
            'excerpt' => 'راهنمای کامل خرید آنلاین: از انتخاب محصول تا پرداخت، ارسال، مرجوعی و نکات مهم — شامل جدول، تصویر، لیست و نقل‌قول.',
            'image' => null,
            'is_active' => true,
            'published_at' => now(),
            'meta_title' => 'راهنمای جامع خرید آنلاین | مجله چینی بازار',
            'meta_description' => 'آموزش گام‌به‌گام خرید از فروشگاه چینی بازار با مثال‌های عملی، جدول مقایسه و نکات کاربردی.',
            'content' => <<<HTML
<h2>مقدمه</h2>
<p>خرید آنلاین وقتی لذت‌بخش است که <strong>شفاف، سریع و قابل اعتماد</strong> باشد. در این مقاله تمام مراحل خرید از چینی بازار را با جزئیات بررسی می‌کنیم — از جستجوی محصول تا دریافت بسته درب منزل.</p>
...
<h2>جمع‌بندی</h2>
<p>با رعایت این نکات، تجربه خرید شما از چینی بازار <strong>سریع، مطمئن و لذت‌بخش</strong> خواهد بود. سوالی دارید؟ به صفحه <a href="/pages/contact">تماس با ما</a> سر بزنید.</p>
HTML,
        ]);
