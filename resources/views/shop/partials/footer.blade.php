      ...
      <div class="max-w-site mx-auto px-4 py-2 md:py-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
          <div class="site-footer__feature">
            ...
            <div>
              <p class="text-sm font-bold">ارسال سریع</p>
              <p class="text-xs text-white/70 mt-0.5">تحویل ۱ تا ۳ روز در تهران</p>
            </div>
          </div>
          <div class="site-footer__feature">
            <span class="site-footer__feature-icon"><svg class="w-5 h-5"
            ...
            <div>
              <p class="text-sm font-bold">ضمانت اصالت کالا</p>
              <p class="text-xs text-white/70 mt-0.5">۷ روز مهلت تست و بازگشت</p>
            </div>
          </div>
          <div class="site-footer__feature">
            <span class="site-footer__feature-icon"><svg class="w-5 h-5"
            ...
            <div>
              <p class="text-sm font-bold">پشتیبانی ۲۴/۷</p>
              <p class="text-xs text-white/70 mt-0.5">پاسخگویی تلفنی و چت آنلاین</p>
            </div>
          </div>
          <div class="site-footer__feature">
            <span class="site-footer__feature-icon"><svg class="w-5 h-5"
            ...
            <div>
              <p class="text-sm font-bold">پرداخت امن</p>
              <p class="text-xs text-white/70 mt-0.5">درگاه بانکی و پرداخت در محل</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-0 md:gap-8 lg:gap-10">
        ...
        <div class="lg:col-span-4 pb-6 md:pb-0 border-b md:border-b-0 border-gray-100">
          ...
          <div class="site-footer__brand-contact mt-4 space-y-2.5">
            <div class="site-footer__contact-item">
              ...
              <span>تلفن: <a href="tel:02191001234"
                   class="hover:text-brand-green transition-colors"
                   dir="ltr">021-9100-1234</a></span>
            </div>
            <div class="site-footer__contact-item">
              <svg class="w-4 h-4"
                   fill="none"
              ...
              <span>موبایل: <a href="tel:09120001234"
                   class="hover:text-brand-green transition-colors"
                   dir="ltr">0912-000-1234</a></span>
            </div>
            <div class="site-footer__contact-item">
              <svg class="w-4 h-4"
                   fill="none"
              ...
              <span>آدرس: تهران، خیابان ولیعصر، بالاتر از پارک ساعی، پلاک ۲۴۵۶</span>
            </div>
          </div>
        ...
        <div class="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-0 sm:gap-6">
          <details class="site-footer__accordion md:block"
                   open>
            <summary>دسترسی سریع<span class="site-footer__accordion-chevron text-gray-400"><svg class="w-4 h-4"
                     fill="none"
                     stroke="currentColor"
                     stroke-width="2"
                     viewBox="0 0 24 24">
            ...
            <div class="site-footer__accordion-body">
              <ul class="space-y-1">
                <li><a href="{{ route('home') }}"
                     class="footer-link">صفحه اصلی</a></li>
                <li><a href="{{ route('products.index', ['sort' => 'created_at', 'direction' => 'desc']) }}"
                     class="footer-link">جدیدترین محصولات</a></li>
                <li><a href="{{ route('products.index', ['sort' => 'views', 'direction' => 'desc']) }}"
                     class="footer-link">پرفروش‌ترین‌ها</a></li>
                <li><a href="{{ route('products.index', ['discounted' => 1]) }}"
                     class="footer-link">تخفیفات ویژه</a></li>
      ...
      <div class="max-w-site mx-auto px-4 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center justify-center sm:justify-end gap-4 text-xs">
          ...
          <a href="{{ route('pages.show', 'privacy') }}"
             class="hover:text-white transition-colors">حریم خصوصی</a>
          <a href="{{ route('pages.show', 'about') }}"
             class="hover:text-white transition-colors">درباره ما</a>
          <a href="{{ route('pages.show', 'contact') }}"
             class="hover:text-white transition-colors">تماس با ما</a>
          <a href="#"
